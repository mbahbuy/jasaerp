...
<script>
    ...
    $(function () {
        ...
        $tableData.on('click', 'button.btn-edit,button.btn-delete', function (){
          ...
          if (clickedButton.hasClass('btn-edit')) {
            ...
            if (confirm(`Apakah anda ingin menghapus data supplier(${uName})?`)) {              
              $.ajax({
                  url: `<?= url_to('preference.supplier') ?>/delete/${uID}`,
                  type: "POST",
                  data: formData,
                  contentType: false,
                  processData: false,
        ...
        btnSimpan.on('click', function (){
          ...
          if (typeSimpan == 'update') {
              ...
              urlSimpan = `<?= url_to('preference.supplier') ?>/update/${SID}`;
  ...
  function generateData(search = null) {
      ...
      if (data.length === 0) {
          $tableData.append('<tr><td colspan="4" class="text-center">Belum ada supplier tercantum</td></tr>');
          return;
      }
              ...
              <tr>
                  <td>
                      <div class="button-group">
                          <button type="button" class="btn btn-default btn-edit" title="edit" data-nama="${data[i].nama}" data-email="${data[i].email}" data-phone="${data[i].phone}" data-nama_toko="${data[i].toko}" data-alamat_toko="${data[i].alamatToko}" data-bank="${data[i].bank}" data-no_rekening="${data[i].noRekening}" data-id="${data[i].id}">
                  ...
                  <td>
                      <div class="button-group">
                          <button type="button" class="btn btn-default btn-delete" title="delete" data-nama="${data[i].nama}" data-email="${data[i].email}" data-phone="${data[i].phone}" data-nama_toko="${data[i].toko}" data-alamat_toko="${data[i].alamatToko}" data-bank="${data[i].bank}" data-no_rekening="${data[i].noRekening}" data-id="${data[i].id}">
