          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <form action="<?= url_to('accounting.jurnalpenyesuaian') ?>" method="get">
                        ...
                        <div class="col">
                            <div class="button-list">
                                ...
                                <!-- <input type="submit" class="btn btn-success" value="Cetak PDF" formtarget="_blank" formaction="<?= url_to('accounting.jurnalpenyesuaian.pdf') ?>" formmethod="post"> -->
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-sm table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th class="align-middle text-center" colspan="2">Jurnal Penyesuaian</th>
                    </tr>
                    <tr>
                      ...
                      <?php if (count($data)): ?>
                          ...
                          <?php for ($i = 0; $i < count($data); $i++): ?>
                              ...
                              <tr>
                                  ...
                                  <td class="align-middle text-center"><?= 'Rp ' . number_format($data[$i]['jumdebit'], 0, '', '.') ?></td>
                                  <td class="align-middle text-center"><?= 'Rp ' . number_format($data[$i]['jumkredit'], 0, '', '.') ?></td>
                              </tr>
                          <?php endfor; ?>
